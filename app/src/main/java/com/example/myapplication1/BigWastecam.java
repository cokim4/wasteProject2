...
public class BigWastecam extends AppCompatActivity {

    static final String TAG = "BigWastecam";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_big_wastecam);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (checkSelfPermission(Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED && checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
                ...
                Log.d(TAG, "권한 설정 요청");
                ActivityCompat.requestPermissions(BigWastecam.this, new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
            }
        }
    ...
    private void photoDialogRadio() {
        ...
        alt_bld.setSingleChoiceItems(PhotoModels, -1, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int item) {
                Toast.makeText(BigWastecam.this, PhotoModels[item] + "가 선택되었습니다.", Toast.LENGTH_SHORT).show();
                if (item == 0) { //갤러리
                    ...
                    mPhotoCircleImageView.setImageResource(R.drawable.ic_camera);
                    img = null;
                }
            }
        });
    ...
    private void takePictureFromCameraIntent() {
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            // 아래 photoURI의 매개변수 3가지 중, 가운데 authority 부분 집중.
            // 이 곳에는 자신의 프로젝트 패키지명 입력.
            // 추가로 2곳에도 변경해줄것
            // 1번 변경은 res> xml> file_paths.xml 의
            //     <external-path name="my_images" path="Android/data/패키지명 입력/files/Pictures" />
            // 2번 변경은 manifest 의
            //<provider
            //            android:name="androidx.core.content.FileProvider"
            //            android:authorities="패키지명 입력"
